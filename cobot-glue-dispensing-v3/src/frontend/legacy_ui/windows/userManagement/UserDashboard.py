...
from frontend.legacy_ui.localization import TranslationKeys, TranslatableWidget, TranslatableDialog
...
from frontend.core.utils.AccessCard import create_complete_access_package2 , PassConfig
