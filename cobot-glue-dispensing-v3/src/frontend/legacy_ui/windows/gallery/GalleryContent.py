...
from frontend.localization import TranslationKeys, TranslatableMixin
from frontend.legacy_ui.widgets.FloatingToggleButton import FloatingToggleButton
from frontend.legacy_ui.windows.gallery.FilterPanel import FilterPanel  # Import our new filter panel
from frontend.legacy_ui.windows.gallery.SelectionActionBar import SelectionActionBar
...
class GalleryContent(QFrame, TranslatableMixin):
    ...
    def __init__(self, thumbnails=None, workpieces=None, onApplyCallback=None,controller = None):
        ...
        if self.thumbnails is None:
            ...
            if workpieces is not None and len(workpieces) != 0:
                from frontend.legacy_ui.windows.gallery.utils import create_thumbnail_widget_from_workpiece
                self.thumbnails = []
    ...
    def show_thumbnail_details(self, filename):
        ...
        if workpiece:
            ...
            try:
                from frontend.legacy_ui.windows.gallery.WorkpieceVisualizationDialog import WorkpieceVisualizationDialog
