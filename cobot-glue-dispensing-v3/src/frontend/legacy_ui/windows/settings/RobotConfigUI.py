...
from frontend.legacy_ui.widgets.virtualKeyboard.VirtualKeyboard import FocusLineEdit,FocusSpinBox,FocusDoubleSpinBox
...
class RobotConfigController:
    ...
    def __init__(self,requestSender):
        ...
        self.config_file = os.path.join(project_root, "src", "backend", 'system', 'storage', 'settings', 'robot_config.json')
