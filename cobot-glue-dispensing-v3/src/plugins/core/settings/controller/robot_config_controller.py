...
from PyQt6.QtWidgets import QMessageBox, QListWidgetItem, QListWidget, QInputDialog
...
class RobotConfigController:
    ...
    def get_current_config(self):
        ...
        safety_limits = self.ui.safety_settings_tab.get_settings()
        general_settings = self.ui.general_settings_tab.get_settings()
        robot_info = general_settings.robot_info
        global_motion_settings = general_settings.global_motion

        return RobotConfig(
            robot_ip=robot_info.robot_ip,
            robot_tool=robot_info.robot_tool,
            robot_user=robot_info.robot_user,
            tcp_x_offset=robot_info.tcp_x_offset,
            tcp_y_offset=robot_info.tcp_x_offset,
