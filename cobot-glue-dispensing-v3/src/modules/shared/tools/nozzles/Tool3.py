class Tool3:
    """
    Class representing Tool3, a specific tool used for dispensing operations.
    ...
    def __init__(self):
        """
        Initializes the Tool3 object with specific offset values and required spraying height.
        ...
        """
        self.xOffset = 54  # x offset from the main tooltip/suction cup
        self.yOffset = -4  # y offset from the main tooltip/suction cup
