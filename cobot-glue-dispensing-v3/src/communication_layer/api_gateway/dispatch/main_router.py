...
class RequestHandler(IRequestHandler):
    ...
    def __init__(self, application: RobotApplicationInterface, settingsController, cameraSystemController, workpieceController:WorkpieceController, robotController, application_factory=None):
        ...
        self.auth_handler = AuthDispatch()
        self.robot_handler = RobotDispatch(self.application, self.robotController)
        self.camera_handler = CameraDispatch(self.application, self.cameraSystemController)
        self.workpiece_handler = WorkpieceDispatch(self.application, self.workpieceController)
        self.settings_handler = SettingsDispatch(self.settingsController)
        self.operations_handler = OperationsDispatch(self.application, application_factory)
